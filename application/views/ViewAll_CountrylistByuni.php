                        ...
                        <div class="listing-item">
                            <article class="geodir-category-listing fl-wrap">
                                ...
                                <div class="listing-item-grid">
                                    <a href="<?php echo base_url() ?>CountrywiseUniversityList/<?php echo $value->country_id ?>">
                                        <div class="bg" data-bg="<?php echo base_url(); ?>/upload/<?php echo $value->country_img ?>"></div>
                                        <div class="d-gr-sec"></div>
                                        <div class="listing-counter color2-bg"><span>16 </span> Locations</div>
                                        <div class="listing-item-grid_title">
                                            <h3><a href="<?php echo base_url() ?>CountrywiseUniversityList/<?php echo $value->country_id ?>"><?php echo $value->country_name ?></a></h3>
    ...
    (function($) {
        ...
        function mainMap() {
            function locationData(locationURL, locationImg, locationTitle, locationAddress, locationCategory, locationStarRating, locationRevievsCounter, locationStatus) {
                return ('<div class="map-popup-wrap"><div class="map-popup"><div class="infoBox-close"><i class="fal fa-times"></i></div><a href="' + locationURL + '" class="listing-img-content fl-wrap"><div class="infobox-status ' + locationStatus + '">' + locationStatus + '</div><img src="' + locationImg + '" alt=""><div class="card-popup-raining map-card-rainting" data-staRrating="' + locationStarRating + '"></div></a> <div class="listing-content"><div class="listing-content-item fl-wrap"><div class="map-popup-location-category ' + locationCategory + '"></div><div class="listing-title fl-wrap"><h4><a href=' + locationURL + '>' + locationTitle + '</a></h4><div class="map-popup-location-info"><i class="fas fa-map-marker-alt"></i>' + locationAddress + '</div></div><div class="map-popup-footer"><a href=' + locationURL + ' class="main-link">Details <i class="fal fa-long-arrow-left"></i></a></div></div></div></div> ')
            }
            //  Map Infoboxes ------------------
            ...
            var locations = [
                ...
                foreach ($country as $key => $value1) {
                    ...
                    $lat = $value1->country_latitude;
                    $lng = $value1->country_longitude;
                    $country_name = $value1->country_name;
                    $image = $value1->country_img;
                ...
                ?>
                    ...
                    [locationData('CountrywiseUniversityList/<?php echo $country_id; ?>', '<?php echo base_url(); ?>/upload/<?php echo $image; ?>', '<?php echo $country_name; ?>', "<?php echo $country_name; ?>", '', "", "", "open"), "<?php echo $lat; ?>", "<?php echo $lng; ?>", 0, '<?php echo base_url(); ?>/upload/<?php echo $image; ?>'],
                <?php
                }
                ?>
