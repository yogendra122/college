			...
			<div class="sb2-2">
				...
				<div class="sb2-2-2">
					<ul>
						...
						<li class="active-bre"><a href="#"> Add Country</a> </li>
						<!-- <li class="page-back"><a href="#"><i class="fa fa-backward" aria-hidden="true"></i> Back</a> </li> -->
					</ul>
				</div>
				<div class="tz-2 tz-2-admin">
					<div class="tz-2-com tz-2-main">
						<h4>Add  Country</h4> <a class="dropdown-button drop-down-meta drop-down-meta-inn" href="#" data-activates="dr-list"><i class="material-icons">more_vert</i></a>
						...
						<div class="split-row">
							<div class="col-md-12">
								<div class="box-inn-sp ad-inn-page">
									...
									<form action="action_addcity" method="post" enctype="multipart/form-data">
													<div class="row">
														...
														<div id="fail" style="display:none" class="input-field col s6">
													...
													<div class="row">
														<div class="input-field col s6">
						                                  ...
						                                  <input id ="ttt" placeholder="Country Name" style="margin-top: 40px;" type="text" name="country_name"  required>
														</div>
													...
													<div class="row">
														...
														<div class="input-field col s6">
															...
															<div class="input-field col s6">
															<input id="phone_number" name="phone_number" placeholder="Phone Number" type="text" class="validate">
															
														</div>
															<div class="input-field col s6">
															<input id="location" name="location" placeholder="Location" type="text" class="validate">
